...
public class gambarbitmap implements Kanvas {
    public static final boolean DEBUG = false;
    public static final boolean DEBUG_TILES_ON_COMMIT = false;
    public static final String TAG = "Markers/gambarbitmap";
    ...
    private class Tile {
        ...
        public void revert(int toVersion) {
            ...
            if (i < 0) {
                // went backward past the end of our tombol_kembali stack
    ...
    public gambarbitmap(int tileSize) {
        mTileSize = tileSize;
    }

    public gambarbitmap(Bitmap bitmap) {
        mWidth = bitmap.getWidth();
        mHeight = bitmap.getHeight();
        mConfig = bitmap.getConfig();
        load(bitmap);
    }
    public gambarbitmap(int w, int h, Bitmap.Config config) {
        mWidth = w;
        mHeight = h;
        mConfig = config;
        load(null);
    ...
    // By using this to get a Canvas to hidayahco.kreasigambar into, you ensure that mVersionInUse is current
